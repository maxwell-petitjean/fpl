# -*- coding: utf-8 -*-
"""streamlit_app_gw11_1.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1P-SUY3eQIEVkvgRrMPdZ7Oet_ku2Sbn6
"""
...
def run_model(fpl_id, transfers, exclude_names, exclude_teams, include_names, budget, picks_data):
    ...
    # gw_df = gw_df0.copy()
    gw_df = pd.concat([gw_df0,gw_df1,gw_df2,gw_df3,gw_df4,gw_df5,gw_df6,gw_df7,gw_df8])
