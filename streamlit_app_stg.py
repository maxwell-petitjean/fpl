...
Original file is located at
    https://colab.research.google.com/drive/1AqOmQpent995VsJeWZcwGEm2shBjb6ys
"""
...
def run_model(fpl_id, transfers, exclude_names, exclude_teams, include_names, budget):
    ...
    selected_team = selected_team[['name','team','pos','cost','ownership','predicted_points','xm','fdr','base_points','gw1','gw2','gw3','gw4','gw5','gw6','starting_weeks']]
